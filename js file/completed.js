...
document.getElementById('task-2').addEventListener('click', function(){
   ...
   const totalTask = document.getElementById('total-task').innerText;
   const task = document.getElementById('task').innerText;
   const convertedTotalTask2 = parseFloat(totalTask);
   const convertedTask2 = parseFloat(task);
   const sum = convertedTotalTask2 + 1;
...
document.getElementById('task-3').addEventListener('click', function(){
   ...
   const totalTask = document.getElementById('total-task').innerText;
   const task = document.getElementById('task').innerText;
   const convertedTotalTask3 = parseFloat(totalTask);
   const convertedTask3 = parseFloat(task);
   const sum = convertedTotalTask3 + 1;
...
document.getElementById('task-4').addEventListener('click', function(){
   ...
   const totalTask = document.getElementById('total-task').innerText;
   const task = document.getElementById('task').innerText;
   const convertedTotalTask4 = parseFloat(totalTask);
   const convertedTask4 = parseFloat(task);
   const sum = convertedTotalTask4 + 1;
...
document.getElementById('task-5').addEventListener('click', function(){
   ...
   const totalTask = document.getElementById('total-task').innerText;
   const task = document.getElementById('task').innerText;
   const convertedTotalTask5 = parseFloat(totalTask);
   const convertedTask5 = parseFloat(task);
   const sum = convertedTotalTask5 + 1;
